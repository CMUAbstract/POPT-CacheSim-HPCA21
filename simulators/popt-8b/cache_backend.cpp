...
void Cache::registerGraph(Graph &g, bool isPull)
{
    m_llc.registerGraph(g, isPull);
}

void Cache::registerOffsetMatrix(uint8_t* offsetMatrix, int32_t numEpochs, int32_t numCacheLines, int vtxPerLine, int dTypeID)
{
    m_llc.registerOffsetMatrix(offsetMatrix, numEpochs, numCacheLines, vtxPerLine, dTypeID);
}

void Cache::updateRegIndex(int32_t index, int tid)
{
    m_llc.updateRegIndex(index, tid);
}

void Cache::updateIrregRanges(int32_t startID, int32_t endID)
{
    m_llc.updateIrregRanges(startID, endID);
}
